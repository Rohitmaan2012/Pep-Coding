public class l_016_mergesortalinkedlist {
	...
	public static class LinkedList {
        ...
        public static LinkedList mergeSort(Node head, Node tail) {
            ...
            LinkedList ans = LinkedList.mergeTwoSortedLists(first,second);
            return ans;
        }
	}
	public static void main(String[] args) {
        ...
        list2.addLast(8);
		list2.display();
        LinkedList list = LinkedList.mergeSort(list1.head, list2.head);
        list.display();
	}
}